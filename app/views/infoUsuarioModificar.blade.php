        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal" action="/infoUsuarioModificar" method="post" id="formRegUsuario">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="email" class="form-control floating-label" id="email" name="email" placeholder="Correo electrónico del profesor" value="{{$usuario->email}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="password" class="col-md-4 control-label">Contraseña</label>
                                        <div class="col-md-8">
                                            <input type="password" class="form-control floating-label" id="password" name="password" placeholder="Contraseña para la cuenta" value="{{$usuario->password}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="id" class="col-md-4 control-label">ID del profesor</label>
                                        <div class="col-md-8">
                                            <input type="number" class="form-control floating-label" id="id" name="id" placeholder="ID personal del profesor" value="{{$usuario->id}}">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!--</fieldset>-->
                            ...
                            <div class="row">
                                <div class="col-md-4 col-md-offset-8">
                                    <button type="button" class="btn btn-primary" id="btnEditarUsuario">Registrar</button>
