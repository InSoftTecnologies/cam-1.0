        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        <li class="active">
                            <i class="fa fa-dashboard"></i> Profesores/ Eliminar Alumno
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form class="form-horizontal" action="/registrarProfesor" method="post" id="formEliAlumno">
                        ...
                        <!--<fieldset>-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-md-offset-8">
                                    <button type="button" class="btn btn-primary" id="btnEliminarAlumno">Buscar</button>
...
@section('js')
    {{HTML::script('/packages/js/eliminarAlumno.js')}}
@stop